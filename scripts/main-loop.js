        ...
        switch (request.opCode) {
            ...
            case operationCodes.getAllDevicePropData:
                ...
                hexString = "48 00 00 00 00 00 00 00" + // 72 distinct properties seems too high?
                    ...
                    "06 00" + // uint32
                    "01 02" + // Only get available
                    "00 00 00 00" + // Factory value
                    "53 80 07 00" + // Current value!
                    "02" + // enum
                    "0d 00" + // 13 values
                    ...
                    "02 00 01 00 03 00 02 00 04 00 03 00" +
                    "01 00 00 00 50 80 07 00 51 80 07 00 52 80 07 00" +
                    "53 80 07 00 59 80 09 00 5a 80 09 00 5b 80 09 00" +
                    "5c 80 09 00 00 80 04 00" +
                    "0d 00" + // 13 values
                    "02 00 01 00 03 00" +
                    "02 00 04 00 03 00 01 00 00 00 50 80 07 00 51 80" +
                    "07 00 52 80 07 00 53 80 07 00 59 80 09 00 5a 80" +
                    "09 00 5b 80 09 00 5c 80 09 00 00 80 04 00" +

                    "10 50" + // Exposure bias compensation
                    "03 00" + // int16
                    "01 01" + // Get and Set available
                    "00 00" + // Factory value
                    "00 00" + // Current value
                    "02" + // enum
                    "1f 00" + // 31 values available
                    "88 13 5c 12 cc 10" + // Starts at 5000, 4700, ... 
                    "a0 0f 74 0e e4 0c b8 0b 8c 0a fc 08 d0 07 a4 06" +
                    "14 05 e8 03 bc 02 2c 01 00 00 d4 fe 44 fd 18 fc" +
                    "ec fa 5c f9 30 f8 04 f7 74 f5 48 f4 1c f3 8c f1" +
                    "60 f0 34 ef a4 ed 78 ec" + // Ends at -4700, -5000
                    "1f 00" + // 31 values supported
                    "88 13 5c 12 cc 10" +
                    "a0 0f 74 0e e4 0c b8 0b 8c 0a fc 08 d0 07 a4 06" +
                    "14 05 e8 03 bc 02 2c 01 00 00 d4 fe 44 fd 18 fc" +
                    "ec fa 5c f9 30 f8 04 f7 74 f5 48 f4 1c f3 8c f1" +
                    "60 f0 34 ef a4 ed 78 ec" + 
                    ...
                    // Continuous (Low speed) = 0x00018012, Continuos = 0x00018013, 
                    ...
                    "36 85 05 00 36 89 05 00 56 83 05 00 56 85 05 00" +
                    "56 89 05 00 76 83 05 00 76 85 05 00 76 89 05 00" +
                    "10 83 05 00 10 85 05 00 10 89 05 00 20 83 05 00" +
                    "20 85 05 00 30 83 05 00 30 85 05 00 28 80 06 00" +
                    "18 80 06 00 29 80 07 00 19 80 07 00" +
                    "31 00" + // 49 values
